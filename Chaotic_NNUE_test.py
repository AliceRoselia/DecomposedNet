...
class singlePerspectiveNet(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Conv1d(1, 1, 3,padding = "same", padding_mode="circular")
    ...
    def forward(self,x):
        ...
        combined_feature = self.conv(combined_feature).squeeze()
...
model.load_state_dict(torch.load("ChaoticNet_epoch1.pt",weights_only=True))
